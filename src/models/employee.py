...
class Employee():
    ...
    def __init__(self, id: int, first_name: str, middle_name: str, last_name: str, phone_number: str, email: str, is_free: bool):
        """
        ...
        # Validate first_name
        if not first_name or type(first_name) != str or not first_name.isalpha():
        ...
        if middle_name and ((type(middle_name) != str) or not middle_name.isalpha()):
